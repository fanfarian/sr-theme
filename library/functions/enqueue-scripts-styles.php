...
function sr_enqueue_scripts_styles()
{
	...
	wp_enqueue_script( 'what-input', get_template_directory_uri() . '/library/vendor/what-input/dist/what-input.min.js', array(), '4.3.1', true );				// What-Input plugin for input specific styles with foundation
	...
	wp_enqueue_script( 'foundation', get_template_directory_uri() . '/assets/js/foundation.min.js', array( 'jquery', 'what-input' ), '6.4.1', true );			// Foundation init + js
