...
function sr_enqueue_scripts_styles()
{
	...
	wp_enqueue_script( 'what-input', get_template_directory_uri() . '/library/vendor/what-input/dist/what-input.min.js', array(), '5.0.4', true );				// What-Input plugin for input specific styles with foundation
	
	// use newest jquery from /library/vendor/
	wp_deregister_script('jquery');																																// disable WP internal jquery for own version
	wp_enqueue_script( 'jquery', get_template_directory_uri() . '/library/vendor/jquery/dist/jquery.min.js', array( ), '3.3.1', true );
	...
	wp_enqueue_script( 'foundation', get_template_directory_uri() . '/assets/js/foundation.min.js', array( 'jquery', 'what-input' ), '6.4.3', true );			// Foundation init + js
